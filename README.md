...
Es ist aus Sicherheitsgründen kein festes Passwort im Repository hinterlegt. Beim ersten Start zeigt die PWA im Bereich **Start** die Ersteinrichtung an. Dort ein Administrator-Passwort mit mindestens 12 Zeichen setzen und sich anschließend mit `admin@demo.schule` und diesem Passwort anmelden. Danach sind Stammdaten, Übungen, Protokolle, Maßnahmen und mobile Meldungen nutzbar.
